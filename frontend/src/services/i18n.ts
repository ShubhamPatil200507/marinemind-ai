...
export const TRANSLATIONS: Record<LanguageCode, TranslationSchema> = {
  en: {
    ...
    auth: {
      ...
      badge_live_satellite: 'Live Satellite Telemetry Online',
      sign_in_tab: 'Skipper Sign In',
      register_tab: 'Register Vessel',
      vessel_id_label: 'Vessel Reg ID or Mobile Number',
      vessel_id_placeholder: 'e.g. IND-MH-01-MM-8492 or 9820145892',
      phone_label: 'Registered Mobile Number',
      phone_placeholder: '10-digit mobile number',
      password_label: 'Security Password / Marine PIN',
      password_placeholder: 'Enter your password',
      name_label: 'Skipper / Owner Full Name',
      name_placeholder: 'e.g. Ramesh Patil',
      harbor_label: 'Base Fishing Harbor',
      harbor_placeholder: 'e.g. Mumbai (Sassoon Docks)',
      sign_in_btn: 'Sign In to Vessel Console',
      register_btn: 'Register & Launch System',
      instant_access_btn: '1-Click Instant Access for Evaluators',
      instant_access_desc: 'Instantly enters console with verified skipper credentials (Capt. Ramesh Patil, Sassoon Docks).',
      demo_credentials_hint: 'Demo Credentials: IND-MH-01-MM-8492 | password: marinepassword',
      logout_btn: 'Sign Out',
      logged_in_as: 'Skipper Console',
      platform_capabilities_heading: 'Key Operational Capabilities',
      feature_agents_title: '10 Specialized AI Agents',
      feature_agents_desc: 'Dynamic autonomous agents for weather, swell waves, ocean productivity, and explainable safety rationale.',
      feature_satellite_title: 'Real-Time Earth Observation',
      feature_satellite_desc: 'Live Open-Meteo marine currents, sea surface temperature, and wave breaker period analysis.',
      feature_imbl_title: 'IMBL Boundary Guardian',
      feature_imbl_desc: 'Autonomous distance auditor warning vessels before entering restricted or international waters.'
    }
  },
  ...
  ta: {
    ...
    auth: {
      ...
      badge_live_satellite: 'நேரடி செயற்கைக்கோள் தரவு இணைப்பு',
      sign_in_tab: 'படகோட்டி உள்நுழைவு',
      register_tab: 'புதிய படகு பதிவு',
      vessel_id_label: 'படகு பதிவு எண் அல்லது அலைபேசி எண்',
      vessel_id_placeholder: 'எ.கா. IND-TN-04-MM-3105 அல்லது 9443210987',
      phone_label: 'பதிவுசெய்த அலைபேசி எண்',
      phone_placeholder: '10 இலக்க அலைபேசி எண்',
      password_label: 'பாதுகாப்பு கடவுச்சொல் / பின்',
      password_placeholder: 'கடவுச்சொல்லை உள்ளிடவும்',
      name_label: 'படகோட்டி / உரிமையாளர் பெயர்',
      name_placeholder: 'எ.கா. செல்வ முருகன் / ரமேஷ் பாட்டீல்',
      harbor_label: 'சொந்த மீன்பிடி துறைமுகம்',
      harbor_placeholder: 'எ.கா. ராமேஸ்வரம் / காசிமேடு',
      sign_in_btn: 'கட்டுப்பாட்டு அறைக்குள் நுழைக',
      register_btn: 'பதிவு செய்து தொடங்கவும்',
      instant_access_btn: 'மதிப்பீட்டாளர்களுக்கு 1-கிளிக் உடனடி அணுகல்',
      instant_access_desc: 'எழுத்து தட்டச்சு இன்றி சரிபார்க்கப்பட்ட படகோட்டி கணக்கில் உடனடியாக நுழையலாம்.',
      demo_credentials_hint: 'மாதிரி கணக்கு: IND-MH-01-MM-8492 | கடவுச்சொல்: marinepassword',
      logout_btn: 'வெளியேறு (Sign Out)',
      logged_in_as: 'படகோட்டி அறை',
      platform_capabilities_heading: 'முக்கிய செயல்பாடுகள்',
      feature_agents_title: '10 சிறப்பு AI ஏஜெண்டுகள்',
      feature_agents_desc: 'வானிலை, அலைகள், மீன்பிடி மண்டலங்கள் மற்றும் பாதுகாப்பான வழித்தட ஆய்வு ஏஜெண்டுகள்.',
